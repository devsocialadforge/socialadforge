  ...
  return (
    ...
    >
      ...
      <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
        {/* Contact Information */}
        <div
          className="space-y-8 hidden md:block animate-fade-in-up"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {contactInfo.map((item, index) => {
              ...
              return (
                <div
                  key={item.title}
                  className="flex items-start space-x-4 group cursor-pointer hover:transform hover:translate-x-2 transition-all duration-300 animate-fade-in-up"
              ...
              {socialLinks.map((social, index) => {
                ...
                return (
                  <a
                    key={social.label}
                    href={social.href}
                    className="w-10 h-10 bg-white/10 hover:bg-white/20 rounded-lg flex items-center justify-center transition-all duration-300 relative overflow-hidden group hover:scale-125 hover:-translate-y-1 hover:rotate-12 animate-fade-in-up"
        ...
        >
          <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 relative overflow-hidden hover:border-white/20 transition-all duration-300">
            ...
            <h3
              className="text-2xl font-semibold text-white mb-6 relative z-10 animate-fade-in-up"
            ...
            {isSubmitted ? (
              <div className="text-center py-12 relative z-10 animate-fade-in-up">
                ...
                <h4
                  className="text-xl font-semibold text-white mb-2 animate-fade-in-up"
                  style={{ animationDelay: "0.3s" }}
                >
                  Message Sent!
                </h4>
                <p
                  className="text-white/70 animate-fade-in-up"
              ...
              <form
                ...
                className="space-y-6 relative z-10 animate-fade-in-up"
              ...
              >
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-semibold py-4 px-6 rounded-lg transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2 relative overflow-hidden hover:scale-102 hover:shadow-lg hover:shadow-blue-500/30 animate-fade-in-up"
          ...
          <div className="absolute -top-4 -right-4 w-8 h-8 bg-gradient-to-r from-blue-400 to-purple-500 rounded-full opacity-60 animate-float-1" />
          <div className="absolute -bottom-4 -left-4 w-6 h-6 bg-gradient-to-r from-pink-400 to-orange-500 rounded-full opacity-40 animate-float-2" />
          <div
            className="absolute top-1/2 -left-2 w-4 h-4 bg-gradient-to-r from-green-400 to-blue-500 rounded-full opacity-30 animate-float-1"
