        ...
        <div ref={cardsRef} className="grid grid-cols-2 gap-3 md:gap-10">
          ...
          <Card className="service-card bg-neutral-900/50 relative border-neutral-800 hover:border-emerald-400/50 transition-all duration-300">
            <CardHeader className="pb-3 md:pb-4">
              ...
              <CardTitle className="text-sm md:text-lg text-neutral-200">
            ...
            <Image
              src="/images/jerry-2.png"
              className={`absolute hidden ${
                direction === "ltr" ? "" : "md:block"
              } bottom-[-15] md:right-[-85] right-[-55]  z-10`}
              alt="Digital Marketing"
              width={500}
              height={500}
            />
            <Image
              src="/images/tom-2.png"
              className={`absolute hidden ${
                direction === "ltr" ? "md:block" : ""
              } bottom-[-15] md:right-[185] right-[-55]  z-10`}
              alt="Digital Marketing"
              width={500}
              height={500}
            />
